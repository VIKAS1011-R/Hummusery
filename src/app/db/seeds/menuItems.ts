...
const sampleMenuItems: CreateMenuItemData[] = [
  {
    ...
    ingredients:
      "Creamy chickpea hummus topped with olive oil, paprika, and fresh herbs.\nServed with warm pita bread and fresh vegetables.",
    isVeg: true,
    price: 975,
    category: "Grab-and-Go Treats",
    isAvailable: true,
  },
  {
    name: "Chicken Shawarma Wrap",
    ingredients:
      "Marinated grilled chicken with garlic sauce, pickles, and fresh vegetables.\nWrapped in soft lavash bread with tahini sauce.",
    isVeg: false,
    price: 1200,
  ...
  },
  {
    ...
    ingredients:
      "Crispy deep-fried chickpea balls with tahini sauce and fresh salad.\nServed with hummus, pickles, and warm pita bread.",
    isVeg: true,
    price: 1125,
  ...
  },
  {
    ...
    ingredients:
      "Assorted Middle Eastern dips including hummus, baba ganoush, and muhammara.\nServed with olives, fresh vegetables, and warm pita bread.",
    isVeg: true,
    price: 1425,
    category: "The Grand Feast",
    isAvailable: true,
  },
  {
    name: "Beef Kofta",
    ingredients:
      "Spiced ground beef skewers grilled to perfection with onions and herbs.\nServed with rice pilaf, grilled tomatoes, and yogurt sauce.",
    isVeg: false,
    price: 1550,
    category: "Rice And Noodles Bowls",
    isAvailable: true,
  },
  {
    name: "Tabbouleh Salad",
    ingredients:
      "Fresh parsley salad with tomatoes, onions, and bulgur wheat.\nDressed with lemon juice, olive oil, and Mediterranean herbs.",
    isVeg: true,
    price: 825,
    category: "Veg Rolls",
    isAvailable: true,
  },
  {
    ...
    ingredients:
      "Pan-grilled Cypriot cheese with honey drizzle and za'atar seasoning.\nServed with fresh mint leaves and warm pita triangles.",
    isVeg: true,
    price: 950,
  ...
  },
  {
    name: "Fish Tagine",
    ingredients:
      "Fresh fish cooked in aromatic Moroccan spices with preserved lemons.\nSlow-cooked with olives, tomatoes, and served with couscous.",
    isVeg: false,
    price: 1875,
    category: "Chinese Veg Rolls",
    isAvailable: true,
  },
  {
    name: "Stuffed Grape Leaves",
    ingredients:
      "Tender grape leaves stuffed with rice, pine nuts, and fresh herbs.\nCooked in lemon broth and served with yogurt dipping sauce.",
    isVeg: true,
    price: 775,
    category: "Chinese Chicken Rolls",
    isAvailable: true,
  },
  {
    name: "Baklava",
    ingredients:
      "Layers of crispy phyllo pastry filled with chopped nuts and honey syrup.\nTraditionally made with pistachios and finished with rose water.",
    isVeg: true,
    price: 450,
    category: "Grab-and-Go Treats",
    isAvailable: true,
